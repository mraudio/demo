...
- (id)init
{
    var theWindow = [[CPPanel alloc]
		initWithContentRect:CGRectMake(0.0, 0.0, 225.0, 125.0) styleMask:CPHUDBackgroundWindowMask | CPClosableWindowMask];
    ...
    if (self)
    {
        ...
        [rotationStartLabel setFrameOrigin:CGPointMake(
			centerX - CGRectGetWidth([rotationStartLabel frame]), 40.0)];
        [rotationEndLabel setFrameOrigin:
			CGPointMake(CGRectGetMaxX([rotationSlider frame]), 40.0)];
